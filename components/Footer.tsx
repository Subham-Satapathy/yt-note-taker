...
export default function Footer() {
  ...
  return (
    <footer className="bg-white border-t border-gray-200 py-8 sm:py-10 lg:py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6 sm:gap-8 mb-8">
          <div className="col-span-2 sm:col-span-3 lg:col-span-1">
            <h3 className="font-bold text-gray-900 mb-3 sm:mb-4 text-lg">snivio</h3>
            <p className="text-sm text-gray-600">AI-powered YouTube video summarizer for instant notes and summaries.</p>
          </div>
          
          <div>
            <h4 className="font-semibold text-gray-900 mb-3 sm:mb-4 text-sm">Product</h4>
            <ul className="space-y-2">
              <li><Link href="/summarize" className="text-sm text-gray-600 hover:text-gray-900 transition-colors">Summarize</Link></li>
          ...
          <div>
            <h4 className="font-semibold text-gray-900 mb-3 sm:mb-4 text-sm">Resources</h4>
            <ul className="space-y-2">
              <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900 transition-colors">Tutorials</a></li>
          ...
          <div>
            <h4 className="font-semibold text-gray-900 mb-3 sm:mb-4 text-sm">Company</h4>
            <ul className="space-y-2">
          ...
          <div>
            <h4 className="font-semibold text-gray-900 mb-3 sm:mb-4 text-sm">Legal</h4>
            <ul className="space-y-2">
        ...
        <div className="border-t border-gray-200 pt-6 sm:pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-xs sm:text-sm text-gray-600 text-center sm:text-left">
            © {currentYear} snivio. All rights reserved.
          </p>
